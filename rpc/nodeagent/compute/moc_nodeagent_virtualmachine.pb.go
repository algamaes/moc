...
type GuestAgentConfiguration struct {
	...
	AcceptExpiredCertUntil *timestamp.Timestamp `protobuf:"bytes,2,opt,name=acceptExpiredCertUntil,proto3" json:"acceptExpiredCertUntil,omitempty"`
	XXX_NoUnkeyedLiteral   struct{}             `json:"-"`
	XXX_unrecognized       []byte               `json:"-"`
	XXX_sizecache          int32                `json:"-"`
}
...
func (m *GuestAgentConfiguration) GetAcceptExpiredCertUntil() *timestamp.Timestamp {
	if m != nil {
		return m.AcceptExpiredCertUntil
	}
	return nil
}
